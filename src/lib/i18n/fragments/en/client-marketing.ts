...
export const clientMarketingEn: Record<string, string> = {
  ...
  'mkt.sol.subtitle': 'Karmax adapts to how you work — solo or with a team, one site or fifty.',
  ...
  // ---- Footer ----
  // (HubSpot-architecture footer: 4-column nav grid — Product,
  //  Integrations | Features, Resources, with a thin vertical
  //  divider between the two pairs — social row between
  ...
  // Kept for the legal pages & route titles (not in the footer):
