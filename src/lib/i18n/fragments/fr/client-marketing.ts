...
export const clientMarketingFr: Record<string, string> = {
  ...
  //  — Produit, Intégrations | Fonctionnalités, Ressources, avec
  //  un filet vertical entre les deux paires — rangée sociale
  //  entre filets, logo centré + copyright + liens légaux
  //  séparés par des barres verticales ; les liens actifs
  ...
  'mkt.footer.mediaLibrary': 'Bibliothèque de médias',
  ...
  // Conservés pour les pages légales et les titres de route :
