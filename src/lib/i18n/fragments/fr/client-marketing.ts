...
export const clientMarketingFr: Record<string, string> = {
  ...
  'mkt.footer.description':
    'La plateforme de contenu multi-sites — rédaction IA, SEO, médias et automatisation, connectée à WordPress ou à tout CMS REST.',
  ...
  'mkt.footer.api': 'API / Développeurs',
  'mkt.footer.company': 'Entreprise',
  'mkt.footer.about': 'À propos',
  'mkt.footer.contact': 'Contact',
  'mkt.footer.careers': 'Carrières',
  'mkt.footer.changelog': 'Journal des modifications',
  'mkt.footer.status': 'Statut',
  'mkt.footer.forTeams': 'Pour les équipes',
